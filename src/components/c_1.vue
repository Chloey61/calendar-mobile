<template>
    <div class="calendar">
        <section class="header">{{ selectData.year }}年{{ selectData.month }}月{{ selectData.day }}日</section>
        <ul class="week-area">
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <li v-for="(item, index) in monthItem" :key="index" :class="['data-item', { selected: item.isSelected }, { 'other-item': item.type !== 'normal' && !isWeekView }]" :style="`height: ${itemHeight}px`" @click="checkoutDate(item)">
